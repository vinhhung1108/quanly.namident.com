...
$this->title = 'Cập nhật điều trị #Khách hàng: ' . $model->khachHang->ma_the;
$this->params['breadcrumbs'][] = ['label' => 'Danh Sách Điều Trị', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => 'Điều trị #Khách hàng: ' . $model->khachHang->ma_the, 'url' => ['view', 'id' => $model->id]];
