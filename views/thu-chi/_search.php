...
<div class="thu-chi-search">
	...
	<div class="row">
		...
		<?= $form->field($model,'loai',['options' =>['class'=>'form-group col-xs-4 col-sm-2']])
    ->dropdownList(ArrayHelper::map(LoaiThuChi::find()->orderBy(['loai_thu_chi'=>SORT_ASC])->all(), 'id', 'loai_thu_chi'), ['prompt' => '— Chọn loại thu/chi —']) ?>
