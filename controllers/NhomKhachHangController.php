...
use app\models\NhomKhachHangSearch;
...
class NhomKhachHangController extends Controller
{
    ...
    {
        $searchModel = new NhomKhachHangSearch();
     ...
     * @param integer $id
     * @return NhomKhachHang the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = NhomKhachHang::findOne($id)) !== null) {
            return $model;
        }
