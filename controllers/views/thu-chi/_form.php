...
<div class="thu-chi-form">
    ...
    <?= $form->field($model, 'ngay_thu',['options'=>['class'=>'form-group col-xs-4 col-sm-3']])->input('date') ?>
	
	<?php //echo $form->field($model,'loai',['options' =>['class'=>'form-group col-xs-4 col-sm-2']])->dropdownList($model->loaithuchi) ?>
	<?php  echo $form->field($model, 'loai',  ['options'=>['class'=>'form-group col-xs-4 col-sm-2']])->widget(Select2::classname(), [
					'data' => $model->loaithuchi,
    ...
    <?= $form->field($model, 'so_tien_t', ['options'=>['class'=>'form-group col-xs-12 col-sm-5']])->widget(\yii\widgets\MaskedInput::className(),[										
										'clientOptions' => [
											'alias' =>  'decimal',
											'groupSeparator' => ',',
											'autoGroup' => true,
